...
private:
  ...
  static Edge *minWeight(vector<Edge *> SmallestEdges);
  static Edge *minDistance(vector<Edge *> SmallestEdges, map<string, int> Weights);
  static vector<Edge *> smallestNeighbors(vector<Vertex *> VisitedArr);
};
